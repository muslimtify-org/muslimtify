...
// Helper: run all 5 prayer time checks for a test case
static void check_all_prayers(struct PrayerTimes *t, const char *fajr, const char *dhuhr,
                              const char *asr, const char *maghrib, const char *isha) {
